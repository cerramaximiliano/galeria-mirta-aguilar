    ...
    <div className="min-h-screen bg-gallery-50 py-8">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          ...
          >
            <h3 className="text-sm font-medium text-gallery-600 mb-1">Total Obras</h3>
          ...
          <motion.div
            ...
            className="bg-white rounded-lg shadow-soft p-4"
          >
            <h3 className="text-sm font-medium text-gallery-600 mb-1">Disponibles</h3>
          ...
          <motion.div
            ...
            className="bg-white rounded-lg shadow-soft p-4"
          >
            <h3 className="text-sm font-medium text-gallery-600 mb-1">Vendidas</h3>
          ...
          <motion.div
            ...
            className="bg-white rounded-lg shadow-soft p-4"
          >
            <h3 className="text-sm font-medium text-gallery-600 mb-1">Valor Total</h3>
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gallery-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-accent transition-colors"
              />
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <select
                ...
                className="px-4 py-2 border border-gallery-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-accent transition-colors"
              >
                {categories.map(cat => (
        ...
        <div className="bg-white rounded-xl shadow-soft overflow-hidden">
          {loading ? (
            ...
            <div className="overflow-x-auto">
              ...
              {/* Pagination Controls */}
              {totalPages > 1 && (
                <div className="mt-6 flex items-center justify-between px-6 py-4 border-t border-gallery-200">
